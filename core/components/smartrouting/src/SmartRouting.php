...
namespace TreehillStudio\SmartRouting;
...
class SmartRouting
{
     ...
     */
    public $namespace = 'smartrouting';

    /**
     * The package name
     * @var string $packageName
     */
    public $packageName = 'SmartRouting';
    ...
    public function __construct(modX &$modx, $options = [])
    {
        ...
        $this->packageName = $this->modx->lexicon('smartrouting');
